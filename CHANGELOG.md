...
- **Vercel Edge Rewrites 瓦片代理**：利用 vercel.json 边缘重写 /tiles/* → OpenFreeMap，绕开 workers.dev 域名在国内被墙的问题；MapContainer 新增 transformRequest 统一拦截瓦片 URL；修复移动端因 sprite/glyph 未代理导致地图空白
